...
const port = args['p'] || process.env.WEB_SERVER_PORT || process.env.PORT;
...
function StartServer(){
    ...
    app.use(session({
        store: MongoStore.create({mongoUrl: 'mongodb+srv://[username]:[password]@[server]'}),
        secret: "secreto",
        resave: true,
    ...
    const webserver = new WebServer(app, io, cfg_authors, cfg_msg, logger);
